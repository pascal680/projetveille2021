...
# hidden layer
model.add(Dense(450, activation='relu')) #Learning from the reinforced patterns in the convolutional layers
...
model.save('image_categorizing_cnn_v3.2.model')

# CONCLUSION
# Ajout de neurone dans la couches dense du modele sur le modele optimiser avec les couches conv2d pour permettre un entrainement plus efficace
# et permettre les liens et la fonction d'etre ajuster plus rapidement
