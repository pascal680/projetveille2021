...
print("actual value " , y_test[index]) #prints actual value meant to be predicted

import matplotlib.pyplot as plt #Permet la visualisation de l'image 28x28 de x_test sur laquelle le convolutional neural network fait son estimation
